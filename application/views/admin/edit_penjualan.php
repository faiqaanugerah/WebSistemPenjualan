          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="text" name="nama_barang" class="form-control" placeholder="Nama Barang" value="<?php echo $pen->nama_barang;?>">
              </div>
              <div class="form-group">
                <label>Harga Barang</label>
                <input type="text" name="harga" class="form-control" placeholder="Harga Barang" value="<?php echo $pen->harga;?>">
              </div>
              <div class="form-group">
                <label>Stock</label>
                <input type="text" name="stock" class="form-control" placeholder="Stock" value="<?php echo $pen->stock;?>">
              </div>
