      ...
      <li class="nav-item active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a class="collapse-item active" href="<?= base_url('admin/Penjualan')?>">Penjualan</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html">Distributor</a>
            <a class="collapse-item" href="utilities-border.html">Kasir</a>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <button class="btn btn-primary" data-toggle="modal" data-target="#tambah_pegawai"><i class="fas fa-plus"></i> Tambah Barang</button>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  <thead>
                    ...
                    <tr>
                      <td><?php echo $no++;?></td>
                      <td><?php echo $pen->nama_barang;?></td>
                      <td><?php echo 'Rp. '.$pen->harga;?></td>
                      <td><?php echo $pen->stock;?></td>
                      <td><?php echo anchor('admin/edit/'.$pen->id_penjualan,('<div class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></div>'));?></td>
                      <td><div onclick="javascript: return confirm('Anda yakin ingin menghapus data ini ?')"><?php echo anchor('admin/hapus/'.$pen->id_penjualan,('<div class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></div>'));?></div>
                      </td>
                    </tr>
                  <?php endforeach;?>
                  </tbody>
