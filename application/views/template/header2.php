                ...
                <div class="top-header-info">
                    <div class="top-contact-info">
                        <ul class="unstyled-list list-inline">
                            <li><span class="phone"> </span>0812-2648-4821</li>
                            <li><span class="mail"> </span><a href="#">iuljr@gmail.com</a></li>
                    ...
                    <div class="cart-details">
                        ...
                        <div class="login-rigister">
                            <ul class="unstyled-list list-inline">
                                <li><a class="rigister" href="<?= base_url('auth/logout')?>">Logout</a></li>
                                <div class="clearfix"> </div>
                            </ul>
                        </div>
                        <div class="clearfix"> </div>
